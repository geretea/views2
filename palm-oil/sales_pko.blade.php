...
<div class="row">
    <div class="col-md-6">
        <div class="card">
    <canvas id="volume_PKOChart" height="300"></canvas>
        </div>
    </div>
     <div class="col-md-6">
        <div class="card">
    <canvas id="revenue_PKOChart" height="300"></canvas>
        </div>
    </div>
 </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center ">
                <h5 class="card-title mb-0">Sales Volume PKO </h5>  
 <a href="{{ url('palm-oil/' . $id . '/sales_pko_pt') }}" class="btn btn-outline-primary">
        Cek Sales Volume PKO Bulanan
    </a>
            </div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center ">
                <h5 class="card-title mb-0">Sales Revenue PKO </h5>  
 <a href="{{ url('palm-oil/' . $id . '/sales_pko_pt') }}" class="btn btn-outline-primary">
        Cek Sales Revenue PKO Bulanan
    </a>
            </div>
...
<script>
const ctx = document.getElementById('volume_PKOChart').getContext('2d');
...
new Chart(ctx, {
    ...
    options: {
        ...
        plugins: {
            title: {
                display: true,
                text: 'Sales Volume PKO per Tahun',
                font: {
                    size: 16
                }
            },
...
<script>
const ctx1 = document.getElementById('revenue_PKOChart').getContext('2d');
new Chart(ctx1, {
    type: 'bar',
    data: {
        labels: {!! json_encode($chartLabels) !!},
    ...
    options: {
        ...
        plugins: {
            title: {
                display: true,
                text: 'Sales Revenue PKO per Tahun',
                font: {
                    size: 16
                }
            },
