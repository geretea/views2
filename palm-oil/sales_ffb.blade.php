...
<div class="row">
    <div class="col-md-6">
        <div class="card">
    <canvas id="volume_FFBChart" height="300"></canvas>
        </div>
    </div>
     <div class="col-md-6">
        <div class="card">
    <canvas id="revenue_FFBChart" height="300"></canvas>
        </div>
    </div>
 </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center ">
                <h5 class="card-title mb-0">Sales Volume FFB </h5>  
 <a href="{{ url('palm-oil/' . $id . '/sales_ffb_pt') }}" class="btn btn-outline-primary">
        Cek Sales Volume FFB Bulanan
    </a>
            </div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center ">
                <h5 class="card-title mb-0">Sales Revenue FFB </h5>  
 <a href="{{ url('palm-oil/' . $id . '/sales_ffb_pt') }}" class="btn btn-outline-primary">
        Cek Sales Revenue FFB Bulanan
    </a>
            </div>
...
<script>
const ctx1 = document.getElementById('volume_FFBChart').getContext('2d');
...
new Chart(ctx1, {
    ...
    options: {
        ...
        plugins: {
            title: {
                display: true,
                text: 'Sales Volume FFB per Tahun (All PT)',
                font: {
                    size: 16
                }
            },
...
<script>
const ctx = document.getElementById('revenue_FFBChart').getContext('2d');
new Chart(ctx, {
    type: 'bar',
    data: {
        labels: {!! json_encode($chartLabels) !!},
    ...
    options: {
        ...
        plugins: {
            title: {
                display: true,
                text: 'Sales Revenue FFB per Tahun (All PT)',
                font: {
                    size: 16
                }
            },
