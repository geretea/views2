@extends('layouts.vertical', ['title' => 'Aplikasi TKKS'])
@section('css')
    @vite([
...
<div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
    <div class="flex-grow-1">
        <h4 class="fs-18 fw-semibold m-0">Aplikasi TKKS</h4>
    </div>
    ...
    <div class="col-12">
        <div class="card">
           <div class="card-header">
                <h5 class="card-title mb-0">Monitoring Aplikasi TKKS (Tahun {{ $tahunAktif }})</h5>  
            </div>
