...
<div class="row">
    <div class="col-md-6">
        <div class="card">
    <canvas id="volume_CPOChart" height="300"></canvas>
        </div>
    </div>
     <div class="col-md-6">
        <div class="card">
    <canvas id="revenue_CPOChart" height="300"></canvas>
        </div>
    </div>
 </div>
...
<div class="row">
 ...
 <a href="{{ url('palm-oil/' . $id . '/sales_cpo_pt') }}" class="btn btn-outline-primary">
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center ">
                <h5 class="card-title mb-0">Sales Revenue CPO </h5>  
 <a href="{{ url('palm-oil/' . $id . '/sales_cpo_pt') }}" class="btn btn-outline-primary">
        Cek Sales Revenue CPO Bulanan
    </a>
            </div>
...
<script>
const ctx1 = document.getElementById('volume_CPOChart').getContext('2d');
...
new Chart(ctx1, {
    ...
    options: {
        ...
        plugins: {
            title: {
                display: true,
                text: 'Sales Volume CPO per Tahun (All PT)',
                font: {
                    size: 16
                }
            },
...
<script>
const ctx = document.getElementById('revenue_CPOChart').getContext('2d');
new Chart(ctx, {
    type: 'bar',
    data: {
        labels: {!! json_encode($chartLabels) !!},
    ...
    options: {
        ...
        plugins: {
            title: {
                display: true,
                text: 'Sales Revenue CPO per Tahun (All PT)',
                font: {
                    size: 16
                }
            },
