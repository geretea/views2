...
<div class="row">
    <div class="col-12">
        <div class="card">
    <canvas id="produksiPKOChart" height="300"></canvas>
        </div>
    </div>
</div>
<!-- Datatables -->
<div class="row">
 ...
 <a href="{{ url('palm-oil/' . $id . '/produksi_pko_pks') }}" class="btn btn-outline-primary">
        Cek Produksi PKO Bulanan
    </a>
            </div>
...
<script>
const ctx = document.getElementById('produksiPKOChart').getContext('2d');
