@extends('layouts.vertical', ['title' => 'Pelatihan Dewan Komisaris'])
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Data Pelatihan Dewan Komisaris (Tahun {{ $tahunTerakhir }}) </h5>
            </div>
        ...
        <tbody>
			  ...
			  <tr class="table-info">
                    ...
                    <td><strong>{{ $totalDurasi ?? 0 }}  Jam</strong></td>
                </tr>
