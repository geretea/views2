...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Direksi Perseroan</h5>
            </div>
          ...
          <thead>
            <tr>
                <th>Nama</th>
                <th>Jabatan</th>
                <th>Tgl Penunjukkan Awal</th>
               <th>Tgl Penunjukkan Terakhir</th>
 ...
 <a href="{{ url('corporate/profil_direksi/' . urlencode($item->nama)) }}">
        {{ $item->nama }}
					...
					<td>{{ $item->jabatan }}</td>
					                    <td>{{  date('d M Y', strtotime($item->tgl_penunjukkan_awal)) }}</td>
