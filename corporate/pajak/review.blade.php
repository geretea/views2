...
<body>
    ...
    <a href="{{ route('corporate.pajak.review', $document->id) }}" class="btn btn-warning">Review Ulang</a>
@endif
        
        <form action="{{ route('corporate.pajak.review.submit', $document->id ?? '') }}" method="POST">
            @csrf
