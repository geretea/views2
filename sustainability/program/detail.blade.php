                        ...
                        <div class="row">
                            <div class="col-xl-12">
                              ...
                              <p class="mb-0 fw-semibold"><span class="fs-11 text-muted fw-normal">{{ $detail->created_at }}</span></p>
                                                ...
                                                <span class="badge bg-primary me-1">Sustainability</span>
    ...
    <ul class="list-group">
        ...
        <li class="list-group-item">
            <div class="d-flex gap-3 flex-wrap align-items-center">
                ...
                <div class="flex-fill">
                    <a href="{{ route('sustainability.program.showID', $post->id) }}" class="fs-14 fw-semibold mb-0">
                        {{ $post->judul }}
                    </a>
                ...
                <div>
                 <a href="{{ route('sustainability.program.showID', $post->id) }}" class="btn btn-icon btn-light btn-sm rtl-rotate">
