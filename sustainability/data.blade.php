@extends('layouts.vertical', ['title' => 'Rantai Pasok'])
...
<div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
    <div class="flex-grow-1">
        <h4 class="fs-18 fw-semibold m-0">Rantai Pasok</h4>
    </div>

    <div class="text-end">
        <ol class="breadcrumb m-0 py-0">
            <li class="breadcrumb-item"><a href="javascript: void(0);">Sustainability</a></li>
            <li class="breadcrumb-item active">Rantai Pasok</li>
        </ol>
    </div>
</div>
...
<div class="row">
    ...
    @endphp		
                <h5 class="card-title mb-0">Data Rantai Pasok</h5>
