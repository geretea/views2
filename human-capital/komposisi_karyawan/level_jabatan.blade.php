        ...
        <div class="card">
            ...
            @foreach($ageGroups as $age)
                <tr>
                    <td>{{ $age }}</td>
                    @foreach($positions as $pos)
                        <td>{{ number_format($data[$age][$pos]['Laki-laki']) }}</td>
                        <td>{{ number_format($data[$age][$pos]['Perempuan']) }}</td>
                    @endforeach
                </tr>
            @endforeach
            <tr>
                ...
                @foreach($positions as $pos)
                                <td><strong>{{ number_format($totals[$pos]['Laki-laki']) }}</strong></td>
                                <td><strong>{{ number_format($totals[$pos]['Perempuan']) }}</strong></td>
                @endforeach
                                 </tr>
        </tbody>
</table>
