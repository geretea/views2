...
<body>
    ...
    <a href="{{ route('human-capital.data.review', $document->id) }}" class="btn btn-warning">Review Ulang</a>
@endif
        
        <form action="{{ route('human-capital.data.review.submit', $document->id ?? '') }}" method="POST">
            @csrf
