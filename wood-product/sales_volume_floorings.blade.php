@extends('layouts.vertical', ['title' => 'WP Sales Engineered Floorings'])
...
<div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
    <div class="flex-grow-1">
        <h4 class="fs-18 fw-semibold m-0">Sales Engineered Floorings</h4>
    </div>
...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Sales Volume Engineered Floorings</h5>
            </div>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Sales Revenue Engineered Floorings</h5>
            </div>
...
<div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Panel Average Selling Engineered Floorings</h5>
            </div>
