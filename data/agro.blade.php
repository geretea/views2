    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Kebutuhan Data Table</h5>
            </div>

            <div class="card-body">
@php
$data = App\Models\Data::where('kategori', 'palm-oil')
                                ->where('sub_kategori', 'Kinerja Operasional') 
                                ->get();
@endphp
