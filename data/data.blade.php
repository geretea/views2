@extends('layouts.vertical', ['title' => 'Data'])
...
$sub_kategori = request()->query('sub_kategori');
@endphp
<!-- Datatables -->
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
				<h5 class="card-title mb-0">Data Tables Kategori: {{ $kategori }} Sub Kategori: {{ $sub_kategori }}</h5>
            </div>

            <div class="card-body">

@php
$data = App\Models\Data::where('kategori', $kategori)
