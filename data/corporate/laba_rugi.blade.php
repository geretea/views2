    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <h5 class="card-title mb-0">Dokumen Pendukung |  <a href="https://onedata.dsng.id/documents/upload" class="btn-upload" target="_blank">
                Upload
            </a></h5>
            </div>

            <div class="card-body">
               @include('documents.index', ['documents' => $documents ?? []])
